...
<h2 align="center" style="color:#008080">Request New Service For Landline</h2>
<p style="font-size:15px;margin-left:20px;font-family:Arial Rounded MT Bold">Select the following Service...</p>
<form name="requestfor" value="requestforlandline" action="action.php" method="post" >
<input type="checkbox" name="request[]" value="roaming" style="margin-left:350px"/>Roaming
